...
export default function SearchBar({handleQuery,queryRef}) {
  return (
    <>
            ...
            <Input ref = {queryRef}  fontSize={"18px"} color={"#ffdc25"} type='search' placeholder='Search'  maxW={"600px"} padding={"20px"} borderRadius={"12px"} border={"none"} backgroundColor={"rgba(255 ,255, 255, 0.7)"} _placeholder={{color:"black",opacity:"1"}}/>
